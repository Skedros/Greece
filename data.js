...
window.TRIP_DATA = {
  ...
  stays: [
    {
      ...
      nights: 3,
      booking: "Vrbo property 8381678. 5 adults. Total €959.65. Booked by James Lohse. Group splits between this and the Lempesi 6 property for the arrival leg. CHECK-IN PROCESS: yellow lockbox on the metal street fence outside (code shared privately by Heidi). Lockbox contains door keys plus an electricity key card. Apartment is on the 1st floor: exit elevator, turn right, take the LEFT door. Inside the apartment, slot the key card into the receiver on the right wall to power everything (including AC). ELEVATOR WARNING: strictly one person plus one piece of luggage at a time, never leave bags alone inside.",
      links: [
    ...
    },
    {
      ...
      nights: 3,
      booking: "Vrbo property 8643658. 5 adults. Total €904.00. Booked by James Lohse. Group splits between this and the Sygrou 29 property for the arrival leg. CHECK-IN PROCESS: pending. Heidi is in touch with the host and will forward the procedure when received.",
      links: [
    ...
    },
    {
      ...
      checkOutTime: "10:00 AM",
      nights: 5,
      booking: "Vrbo property 11694637. 7 adults. Total €3,050.00. Booked by Maria Skedros. Host: Tsichlaki Maria (Be On Holidays). This is the Skedros-side villa. Group splits across Villa Dioni and Park-view villa. CHECK-IN PROCESS: pending from host, Maria will coordinate.",
      links: [
    ...
    },
    {
      ...
      checkOutTime: "10:00 AM",
      nights: 5,
      booking: "Vrbo property 11473645. 7 adults. Total €3,107.38. Booked by James Lohse. This is the Lohse-side villa. CHECK-IN: Xrisanthi is the check-in host, phone +30 6948364409. GPS 35.512298, 23.979078. Greek law requires guests to complete an arrival form at links.guesteasy.gr/checkin before arrival (form had loading issues for some guests, try with VPN or browser translate).",
      links: [
    ...
    },
    {
      ...
      nights: 2,
      booking: "Expedia itinerary #73424648455870. 4 Classic Triple Rooms (sleeps the full group of 12). Reserved by Heidi Lohse, booked Apr 19, 2026. Total $1,595.31 (paid $1,576.47 on Visa, $18.84 due at property for city tax). Continental breakfast included, free WiFi, AC. 24-hour airport shuttle available for EUR 55 per vehicle (4 max). 3 min walk to Syntagma Square, 9 min to Monastiraki, 10 min to the Parthenon. CHECK-IN PROCESS: pending. Heidi is in contact with the host and will forward the procedure when received.",
      links: [
  ...
  days: [
...

    {
      ...
      slots: [
        {
          time: "8:30 AM",
          headline: "Acropolis Guided Tour (BOOKED)",
          description: "Confirmed guided tour at 8:30 AM. Arrive at the meeting spot by 8:10 AM (20 minutes early). The meeting spot will be communicated by the tour operator in advance. Allow 2 to 2.5 hours on site. The Propylaia, Parthenon, Erechtheion with the Caryatids, and Temple of Athena Nike are the headliners.",
          links: [
            { label: "Official Acropolis info", url: "https://odysseus.culture.gr/h/3/eh355.jsp?obj_id=2384" }
          ],
          tip: "Confirm the exact meeting spot with the tour operator 24 to 48 hours before. Bring water, hat, and shoes with grip."
        },
        {
          time: "11:00 AM",
  ...
  sites: [
    /* ATHENS */
    { name: "Acropolis", city: "Athens", type: "Archaeological site, UNESCO", description: "The fortified rock at the center of Athens, crowned by the Parthenon (447 to 432 BC). Also the Erechtheion with the Caryatid porch, the Propylaia, and the Temple of Athena Nike.", cost: "EUR 30 pp (mandatory timed entry, daily cap of 20,000 visitors)", hours: "Summer (Apr 1 - Oct 31): 8:00 AM to 7:30 PM, last entry 7:00 PM", whenToVisit: "8:00 AM first slot for cool and few crowds. Book 5+ days ahead in peak season; sells out.", website: "https://odysseus.culture.gr/h/3/eh355.jsp?obj_id=2384", tickets: "https://hhticket.gr (only official source, no fees)", tips: "Modest dress. No selfie sticks. Bring water. Shoes with grip. Ticket valid only within the booked 2-hour window." },
    { name: "Acropolis Museum", city: "Athens", type: "Museum", description: "Modern museum across from the south slope. Houses the original sculptures from the site. The glass top floor frames the actual Parthenon.", cost: "EUR 20 pp", hours: "Summer (Apr-Oct): Mon 9:00 AM to 5:00 PM, Tue-Thu and Sat-Sun 9:00 AM to 8:00 PM, Fri 9:00 AM to 10:00 PM. Last entry 30 min before close. NOTE: Jun 8 is a Monday so shorter hours.", website: "https://www.theacropolismuseum.gr", tickets: "https://etickets.theacropolismuseum.gr", tips: "Top floor cafe has Parthenon views. Friday is the longest day if you want maximum time." },
    ...
    { name: "National Archaeological Museum", city: "Athens", type: "Museum", description: "World-class collection of Greek antiquities. The Mask of Agamemnon, the Jockey of Artemision, the Antikythera Mechanism. Allow 2.5 to 3 hours.", cost: "EUR 20 pp (raised from EUR 12 on Jan 1, 2026)", hours: "Summer (May 4-Nov 15): Wed-Mon 8:00 AM to 8:00 PM, Tue 1:00 PM to 8:00 PM. Last admission 7:30 PM.", website: "https://www.namuseum.gr", tickets: "Buy at the door or online via hhticket.gr", tips: "Metro Line 1 (green) to Viktoria." },
    ...
    { name: "Panathenaic Stadium", city: "Athens", type: "Historical site", description: "The only stadium in the world built entirely of marble. Site of the first modern Olympic Games (1896).", cost: "EUR 10 pp (raised from EUR 5 on Oct 1, 2025), audio guide included", hours: "8:00 AM to 7:00 PM (Mar-Oct), last ticket 7:00 PM", website: "https://www.panathenaicstadium.gr", tickets: "Buy at the gate only (no online sales)", tips: "Climb to the top of the stands for the view across to Lycabettus and the Acropolis." },
    ...
    /* CHIOS */
    { name: "Nea Moni Monastery (UNESCO)", city: "Chios", type: "Religious site, UNESCO", description: "11th-century monastery 14 km into the mountains from Chios Town. The katholikon has some of the finest surviving Byzantine mosaics anywhere. Active monastery.", cost: "Monastery: FREE entry. Refectory Museum: small fee EUR 2 to 4 pp", hours: "Summer hours: 9:00 AM to 1:00 PM AND 5:00 PM to 8:00 PM (closed midday for monks' rest)", website: "https://odysseus.culture.gr/h/3/eh355.jsp?obj_id=1822", tickets: "At the door", tips: "Modest dress required (shoulders and knees covered). Plan around the midday closure." },
    { name: "Chios Mastic Museum", city: "Chios", type: "Museum", description: "Modern museum on the cultivation, harvesting, and processing of mastic, located in Pyrgi (south Chios), not Chios town. Run by the Piraeus Bank Group Cultural Foundation.", cost: "EUR 6 pp", hours: "10:00 AM to 6:00 PM, closed Tuesdays", website: "https://www.piop.gr/en/diktuo-mouseion/chios-mastic-museum/", tickets: "At the door", tips: "1 hour visit. Shop downstairs has the best mastic product selection. Free parking on site." },
    ...
    /* CRETE */
    { name: "Samaria Gorge", city: "Crete", type: "National park, hike", source: "Georgia (Chania local)", description: "16 km gorge through the White Mountains, ending at the Libyan Sea. Begins at Omalos plateau (1230m) and descends through pine forest, past the abandoned Samaria village, through the Iron Gates where walls narrow to 4 meters and rise 300m. Strenuous, 4 to 7 hours, mostly downhill. Ends at Agia Roumeli, only reachable by foot or boat. Historically a strategic position for the Cretan resistance during WWII, where locals hid British soldiers and helped them escape after the German invasion of Crete.", cost: "EUR 10 pp gorge entry, EUR 14 ferry Agia Roumeli to Sougia (or to Chora Sfakion), EUR 7-15 bus back to Chania. Total DIY ~EUR 35-45 pp. Guided tour from Chania ~EUR 35-60 pp all-inclusive.", hours: "Open 7:00 AM, must be out by 6:00 PM. May through October only (closed in winter).", website: "https://www.samaria.gr", tickets: "Pay at the gate in cash or card, or online in advance. Children under 18 and seniors 65+ FREE.", tips: "Real hiking shoes, 2L water minimum. Natural spring water available along route. Last 3km from village to ferry can be brutal on tired legs; small private bus available at exit. Most Chania harbor tour operators sell all-in packages with transport." },
    ...
    { name: "Elafonisi Beach", city: "Crete", type: "Beach", description: "Pink-sand beach (color from crushed shells) on the southwest tip. Shallow lagoon, perfect for non-swimmers. Protected Natura 2000 site. On the drive: several picturesque villages, plus a chapel built into a cave reached by stairs cut into the mountainside.", cost: "Free entry, EUR 5 parking at Mega Parking facility, optional sunbed rental ~EUR 8", hours: "Always open", website: "", tickets: "", tips: "73 km from Chania, 1.5 hr mountain drive (paved road). Don't take pink sand home (it's protected). Strong winds can create sandblasting conditions, check forecast." },
    ...
    { name: "Manousakis Nostos Winery", city: "Crete", type: "Winery", source: "Georgia (Chania local)", description: "Family-run organic winery in Vatolakkos (15 min from Chania) since 1997. Ted Manousakis (who lives in northern Virginia) founded it; his daughter and son-in-law run it, with the son-in-law as chef. All food sourced from their own land or locally. Tours, tastings, and a strong food menu. Closed Sundays. BOOKING REQUIRED.", cost: "Free tour, EUR 15 tasting (5 wines + Cretan rusks, olive oil, sea salt), EUR 45 pp lunch with tasting (groups 10+ only, includes Cretan salad, kalitsounia, dolmades, youvetsi, yogurt + unlimited wine)", hours: "10:00 AM to 8:00 PM daily (closed Sundays). Tours at 12 PM, 2 PM, 4 PM, 6 PM, 8 PM.", website: "https://www.manousakiswinery.com", tickets: "Book at +30 28210 78787 or info@manousakiswinery.com or via the website", tips: "Half-day visit. Good rest-day option for non-hikers on Samaria day. Manousakis family are partners with the owners of Salis restaurant in Chania harbor." },
    ...
    { name: "Botanical Park & Gardens of Crete", city: "Crete", type: "Garden, walking park", description: "20 hectares of fruit trees, herbs, and medicinal plants in a steep ravine, with a creek and walking paths. Born from the ashes of a 2003 wildfire.", cost: "EUR 8 pp adults, EUR 4 kids 6-12, under 6 free", hours: "9:00 AM to sunset, March to November (closed in winter)", website: "https://www.botanical-park.com", tickets: "At the entrance", tips: "18 km from Chania. Allow 2 hours to walk the loop. On-site restaurant at the entrance/exit serves great food." },
